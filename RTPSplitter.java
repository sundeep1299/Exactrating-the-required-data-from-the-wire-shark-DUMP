...
public class RTPSplitter {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final String filename = "/Users/vijayendrasai/Documents/TcpDump/httpdump.pcap";
    ...
    private static class FrameHandlerImpl implements PacketHandler {
        ...
        private void processRtpFrame(final RtpPacket rtp) throws PacketParseException {
            ...
            final String key = ((IPPacket) rtp.getParentPacket().getParentPacket()).getSourceIP() + ((TransportPacket) rtp.getParentPacket()).getSourcePort();
